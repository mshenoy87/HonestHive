...
import {loadWaggles} from './lookup';
import {Waggle} from './detail'

export function WaggleList(props) {
  ...
  useEffect(() => {
    if (wagglesDidSet === false) {
      ...
      loadWaggles(props.username, callback, nextURL);
    }
  }, [wagglesInit, props.username, wagglesDidSet, setWagglesDidSet])
  ...
  const handleLoadNext = (event) => {
    ...
    if (nextURL !== null) {
      ...
      loadWaggles(props.username, handleLoadNextResponse, nextURL);
    }
  }
